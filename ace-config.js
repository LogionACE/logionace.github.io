...
window.ACE_CONFIG = Object.freeze({
  ...
  /*
   * Which manifest counts as approved -- its digest and its provenance commit --
   * lives in `ace-approved-pin.js` and nowhere else. Two constants, generated by
   * `tools/ace_artifacts.py build`, kept out of this file so that republishing
   * the public numbers is never a side effect of editing configuration.
   */
